...
% ***** title
%
\title{Multi Language Browser Support}

%
% ***** author's name
%
\author{Swapnil Mohan Patil}
%
% ***** graduation year
%
\copyrightyear{2017}
...
\bibliography{references.bib} % To build the references, double click the file "genbib.bat" in the "build" subdirectory
